...
import {appendDot} from "./svg/append-dot.js"
/**
...
export const drawHanger = (center, r, width=20, thickness=10, degrees=-20)=>{
    ...
    let [hangerEdgePoint, hangerEdgePoint2] = intersetCircleCircle(center, r3, center2, hangerRadius);
    let [hangerEdgePoint3, hangerEdgePoint4] = intersetCircleCircle(center, r3, center2, hangerInnerRadius);
